...
-----------------------------------------------------------------------------------------------------------------|
--  ^[aeiou]           |  First character is one of vowels(From any character listed between the square brackets)|
--  [aeiou]$           |  End character is one of vowels (From any character listed between the square brackets) |
--    .*       	       |  Represent any numbers of any characters.			                         |
-----------------------------------------------------------------------------------------------------------------|
