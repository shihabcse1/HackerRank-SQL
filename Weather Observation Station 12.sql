...
--Problem Link : https://www.hackerrank.com/challenges/weather-observation-station-12/problem?h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen&h_r=next-challenge&h_v=zen

SELECT DISTINCT city
FROM station
WHERE city REGEXP '^[^aeiou].*[^aeiou]$';

-- ".*" can represent any string of any length.
-- "^[^aeiou]" means city names do not start with vowels.
-- "[^aeiou]$" means city names do not end with vowels.
